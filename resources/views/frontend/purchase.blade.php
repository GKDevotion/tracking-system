 ...
 @section('content') 
    <style>
        ...
        /* Payment Card Styles */
        .payment-card { 
            border: 2px solid #eee; cursor: pointer; transition: all 0.3s ease; border-radius: 12px;
            text-align: center; padding: 10px; height: 100%; background: #fff;
        }
        ...
        .qr-container { 
            ...
            border: 2px dashed #dee2e6; transition: all 0.4s ease;
        }
