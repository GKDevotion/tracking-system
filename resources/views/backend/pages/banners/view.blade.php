        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('web.banners.edit', $banners) }}" class="btn btn-sm btn-outline-warning">
                            <i class="bi bi-pencil"></i> Edit
                        </a>
                        <a href="{{ route('web.banners.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                    @if($banners->image_path)
                        <div class="mb-3">
                            <img src="{{ asset('storage/app/public/' . $blog->image_path) }}" class="img-fluid rounded" style="max-height: 400px; object-fit:cover;">
                        </div>
                    @endif
