    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ $plan->exists ? route('web.plans.update', $plan) : route('web.plans.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="3"
                                      ...
                                      placeholder="800-1,000 Points / Month" required>{{ old('description', $plan->description) }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="features" rows="5"
                                      ...
                                      placeholder="Enter each feature on a new line" required>{{ old('features', $plan->features ? implode("\n", $plan->features) : '') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="link" value="{{ old('link', $plan->link) }}"
                                   ...
                                   placeholder="purchase?plan=advanced" required>
