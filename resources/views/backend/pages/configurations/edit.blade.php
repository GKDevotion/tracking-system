    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('web.configurations.update', $configuration) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3"> 
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="value" rows="3"
                                      ...
                                      placeholder="Configuration value">{{ old('value', $configuration->value) }}</textarea>
                            @error('value')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-12">
                            <label class="form-label">Display Name <span class="text-danger">*</span></label>
                            <input type="text" name="display_name" value="{{ old('display_name', $configuration->display_name) }}"
